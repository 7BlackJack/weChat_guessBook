...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "39430a86-2-" + i0 + "-" + i1 + "," + ("39430a86-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "39430a86-1-" + i0 + ",39430a86-0"
      } : {}, {
        c: data,
        g: "39430a86-3-" + i0 + ",39430a86-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "39430a86-0"),
    c: common_vendor.p({
      collection: $data.collectionList,
      field: "title,desc,timestamp,diydesc"
    }),
    d: common_vendor.sr("fab", "39430a86-4"),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/\u684C\u9762\u6587\u4EF6/test/weChat-guessBook/pages/tiehe/time-line/list.vue"]]);
