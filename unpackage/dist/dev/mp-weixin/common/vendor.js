...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.56.1",\n        "192.168.66.1",\n        "192.168.88.1",\n        "10.23.38.116"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "C:/Program Files/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"labproject","spaceId":"9271d4a7-8bd9-4e06-8152-6a452182204e","clientSecret":"3AZCEm4AKnMvOwqTe5xgnQ==","endpoint":"https://api.bspapp.com"}]') || [];
let _ = "";
try {
  _ = "__UNI__F279E42";
} catch (e2) {
